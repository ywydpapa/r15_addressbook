...
// StatefulWidget으로 선언
class CMemberSearchScreen extends StatefulWidget {
  const CMemberSearchScreen({Key? key}) : super(key: key);

  @override
  _CMemberSearchScreenState createState() => _CMemberSearchScreenState();
}

class _CMemberSearchScreenState extends State<CMemberSearchScreen> {
  ...
  Future<void> _searchMembers() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('${ApiConf.baseUrl}/phapp/csearchmember/$mclubNo/$keyword'),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.yellow, title: Text('클럽 회원 검색')),
